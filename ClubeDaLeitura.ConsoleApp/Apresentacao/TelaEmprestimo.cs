...
public class TelaEmprestimo
{
    ...
    public string? ObterOpcaoMenu()
    {
        ...
        Console.WriteLine("S - Voltar ao inicio");
        Console.WriteLine("---------------------------------");
        Console.Write("> ");
    ...
    public void VisualizarTodos(bool deveExibirCabecalho)
    {
        ...
        Console.WriteLine(
            ...
            "Id", "Revista", "Amigo", "Início", "Conclusão Prev", "Status"
        );
    ...
    {
        // 1. Selecionar uma revista disponivel
        VisualizarRevistas();
        ...
        // 2. Selecionar um amigo disponivel
        Console.WriteLine("---------------------------------");
